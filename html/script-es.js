...
function setupLocations(locations, myHouses) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="¿Dónde quieres empezar?"><p><span id="null">¿En dónde te gustaría comenzar?</span></p></div>')
...
function setupApps(apps) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Elige un apartamento"><p><span id="null">Elige un apartamento</span></p></div>')
